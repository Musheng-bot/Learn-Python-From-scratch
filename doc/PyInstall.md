...
麻烦参考[Mac安装Python官方教程](https://docs.python.org/zh-cn/3/using/mac.html)，本人没有用过Mac系统
...
以上教程走完你应该有一个基础的开发工具了，以下面这段话开始你的编程之旅吧

```python
print("Hello World")
```

> Tip: 在命令行中打开你的py文件所在文件夹，使用 `python your_file_name.py`可以运行以上程序
